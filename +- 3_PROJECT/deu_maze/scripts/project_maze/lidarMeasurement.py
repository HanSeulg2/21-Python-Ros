...
def scan_callback(msg):
  ...
  floatmsg.range_ahead = msg.ranges[len(msg.ranges)/2] #front
  floatmsg.range_rear = msg.ranges[len(msg.ranges)*0] # back
  floatmsg.range_right = msg.ranges[len(msg.ranges)/4] # right
  floatmsg.range_left = msg.ranges[len(msg.ranges)/4*3] #left
